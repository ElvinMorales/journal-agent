...
| Tools | `scripts/`, `scripts/init-private-vault.py`, `docs/future-mcp-vps-controller-contract.md`, `docs/decisions/0003-journal-mirror-mcp-runtime.md` | Validation, redaction, and safe private-vault initialization helpers plus design-only least-privilege controller and MCP tool boundaries | Public tooling and specifications; generated private vault and outputs remain outside Git | Private-vault initializer covered; controller contract covered; MCP implementation absent |
| Knowledge/resources | `references/`, `docs/`, `docs/guided-intake.md`, `examples/intake/intake-to-memory-state-proposals.synthetic.md`, `docs/obsidian-private-runtime-guide.md`, `docs/private-vault-runtime-package.md`, `docs/v0.2-usable-product-handoff.md`, `docs/release-notes/v0.2.0.md` | Supporting public references, guided-intake guidance and walkthroughs, private-runtime and initializer guidance, release notes, and a public-reader handoff | Public-safe guidance and synthetic walkthroughs only; intake answers and generated private vault content stay outside Git | Covered for structured intake, private setup and initialization, and v0.2 handoff |
...
| Memory | `MEMORY.md.example`, `scripts/init-private-vault.py`, `docs/private-vault-runtime-package.md`, `prompts/guided-intake.md`, `docs/guided-intake.md`, `schemas/intake-response.schema.json`, `schemas/memory-update-proposal.schema.json`, `examples/intake/`, `examples/memory-state-proposals/`, `evals/intake-boundary-cases.md`, `evals/memory-state-proposal-cases.md`, `prompts/update-proposal-review.md`, `skills/memory-state-review/SKILL.md`, `docs/memory-state-proposal-review.md`, `docs/future-mcp-vps-controller-contract.md`, `private/memory/` | Durable user-approved context, blank generic Memory starters, structured intake-to-Memory candidates, reviewable proposals, and a separately confirmed future exact-wording apply boundary | Initializer and definitions public; generated starter files, real Memory, and proposals private and outside Git | Private starter structure and proposal boundary covered; MCP apply planned, not implemented |
| State | `STATE.md.example`, `scripts/init-private-vault.py`, `docs/private-vault-runtime-package.md`, `prompts/guided-intake.md`, `docs/guided-intake.md`, `schemas/intake-response.schema.json`, `schemas/state-update-proposal.schema.json`, `examples/intake/`, `examples/memory-state-proposals/`, `evals/intake-boundary-cases.md`, `evals/memory-state-proposal-cases.md`, `prompts/update-proposal-review.md`, `skills/memory-state-review/SKILL.md`, `docs/memory-state-proposal-review.md`, `docs/future-mcp-vps-controller-contract.md`, `private/state/` | Temporary context, blank generic State starters, structured intake-to-State candidates, review/stale/expiration handling, and a separate future exact-wording apply boundary | Initializer and definitions public; generated starter files, live State, and proposals private and outside Git | Private starter structure and proposal boundary covered; MCP apply planned, not implemented |
| Planning/orchestration | `prompts/guided-intake.md`, `docs/guided-intake.md`, `examples/intake/intake-to-memory-state-proposals.synthetic.md`, `skills/journal-mirror-session/SKILL.md`, `docs/journal-mirror-workflow.md`, `docs/obsidian-private-runtime-guide.md`, `docs/private-vault-runtime-package.md`, `scripts/init-private-vault.py`, `docs/memory-state-proposal-review.md`, `docs/roadmap-v0.3.0.md` | Guided onboarding, intake-to-proposal flow, workflow sequencing, private setup and initialization, selected-context reflection, proposal lifecycle, review gates, and the planned MCP runtime sprint | Public instructions, initializer, synthetic walkthroughs, and specifications only; generated vaults, intake answers, sessions, and filled proposals remain private | Structured intake, sessions, and private initialization covered; MCP runtime planned, not implemented |
| Guardrails/governance | `GUARDRAILS.md`, `PRIVACY.md`, `SECURITY.md`, `CONTRIBUTING.md`, `scripts/init-private-vault.py`, `docs/private-vault-runtime-package.md`, `prompts/guided-intake.md`, `docs/guided-intake.md`, `evals/intake-boundary-cases.md`, `skills/*/SKILL.md`, `evals/safety-boundary-cases.md`, `evals/journal-mirror-session-cases.md`, `evals/future-controller-boundary-cases.md`, `docs/decisions/`, `docs/memory-state-proposal-review.md`, `docs/future-mcp-vps-controller-contract.md` | Safety, privacy, initializer path refusal, intake skip and sensitive-topic limits, trust metadata, exact-wording approval, release gates, controller denials, architectural decisions, and boundary tests | Public rules, initializer, metadata, contracts, decisions, checklists, and synthetic tests; no sensitive runtime artifacts | Private-path initialization and structured intake/session boundaries covered; MCP architecture denials proposed |
...
| Evaluation/observability | `tests/test_init_private_vault.py`, `EVALS.md`, `evals/`, `evals/intake-boundary-cases.md`, `evals/future-controller-boundary-cases.md`, `prompts/guided-intake.md`, `examples/intake/`, `examples/journal-mirror-walkthroughs/`, `examples/memory-state-proposals/`, `docs/roadmap-v0.3.0.md` | Automated initializer safety/idempotency checks plus manual regression, guided-intake boundaries, safety review, release verification, and planned MCP runtime tests | Public-safe tests, synthetic cases, and control-plane checks only; private traces, content logs, and clinical validation excluded | Initializer tests and structured intake evals covered; MCP runtime tests planned |
| Runtime/deployment | `mobile/`, `.gitignore`, `.github/workflows/`, `scripts/init-private-vault.py`, `tests/test_init_private_vault.py`, `docs/private-vault-runtime-package.md`, `docs/obsidian-private-runtime-guide.md`, `docs/v0.2-usable-product-handoff.md`, `docs/release-notes/v0.2.0.md`, `docs/release-checklist-v0.2.0.md`, `docs/future-mcp-vps-controller-contract.md`, `docs/decisions/0002-journal-mirror-runtime-pattern.md`, `docs/roadmap-v0.3.0.md`, `docs/decisions/0003-journal-mirror-mcp-runtime.md` | Generic private-vault initialization, public/private boundaries, and the proposed control, data, runtime-edge, interaction, and inspection planes | Initializer code is public; generated vault and runtime private data stay outside the repo | Private-vault package covered; MCP runtime planned, not implemented |
...
- Guided intake artifacts and private-vault initialization are present; MCP server behavior, connector setup, runtime tests, and the local viewer remain separate follow-up issues.
...
Guided intake maps across Prompts/interfaces, Knowledge/resources, Memory, State, Planning/orchestration, Guardrails/governance, Outputs/schemas, Evaluation/observability, and Learning/iteration. The private-vault package maps across Tools, Knowledge/resources, Memory, State, Planning/orchestration, Guardrails/governance, Evaluation/observability, Runtime/deployment, and Learning/iteration. MCP planning artifacts map across the same existing framework where applicable. These mappings do not create new top-level categories; the taxonomy remains exactly 14 buckets.
